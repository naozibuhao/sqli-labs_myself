<!--
 * @Author: your name
 * @Date: 2020-04-26 14:07:30
 * @LastEditTime: 2020-04-26 14:10:24
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \undefinede:\tmp\myctf\sqli-labs\readme.md
 -->
README
================
...
2020-4-26 
1. 在原有基础上添加sql打印功能,协助在sql学习过程中查看执行的sql语句
2. 修改方式./config/config.php中 $flagecho = true;  true为打印 false不打印
